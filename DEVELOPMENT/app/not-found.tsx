    ...
    <main className="min-h-screen flex items-center justify-center px-4">
      <div className="max-w-md text-center">
        ...
        <p className="text-si-white-muted mb-8 leading-relaxed">
          This page doesn&apos;t exist or has been moved. Let us point you back to where you need to be.
        </p>
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          ...
          <Link href="/contact" className="px-6 py-3 border border-white/20 text-si-white rounded-xl hover:border-si-teal hover:text-si-teal transition-colors">
            Contact us
          </Link>
        </div>
      </div>
